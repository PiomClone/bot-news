...
func (g *GroqSummarizer) Summarize(ctx context.Context, articles []storage.Article) (string, error) {
	...
	prompt := fmt.Sprintf(
		"Ты — редактор новостного Telegram-дайджеста. Сделай краткую и информативную выжимку материалов за %s на основе предоставленных заголовков и описаний.\n\n"+
			"Правила:\n"+
			"1. Сгруппируй статьи по 2-4 смысловым темам. Для каждой темы придумай жирный заголовок с 2-3 подходящими эмодзи.\n"+
			...
			"4. В каждом пункте ОБЯЗАТЕЛЬНО сделай гиперссылку на ключевое слово-действие или событие: [слово](url). Не вставляй голые ссылки.\n"+
			...
			"*Выжимка за [дата]:*\n\n"+
			"*эмодзи ТЕМА*\n"+
			"- @channel: Текст новости с [ссылкой](url).\n"+
			"- ...\n\n"+
