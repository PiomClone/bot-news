...
func (g *GroqSummarizer) Summarize(ctx context.Context, articles []storage.Article) (string, error) {
	...
	prompt := fmt.Sprintf(
		"Ты — редактор новостного Telegram-дайджеста. Сделай выжимку материалов за %s.\n\n"+
			...
			"3. В каждом пункте ОБЯЗАТЕЛЬНО сделай гиперссылку на ключевое слово-действие (глагол или существо события): [слово](url). Не вставляй голую ссылку.\n"+
			"4. Пропускай рекламу, самопиар и неинформативные посты.\n"+
			"5. Только русский язык. Никаких пояснений от себя — только дайджест.\n\n"+
			"Формат:\n"+
			"*Выжимка за [дата]:*\n\n"+
			"*эмодзи Тема*\n"+
			"- Субъект [глагол](url) подробности.\n"+
			"- ...\n\n"+
			"Материалы:\n%s",
		date, sb.String(),
	)
